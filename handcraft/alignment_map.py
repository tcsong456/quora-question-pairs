...
if __name__ == '__main__':
    ...
    np.save('artifacts/training/alignment_features.npy', train_features.astype(np.float32))
    np.save('artifacts/prediction/alignment_features.npy', test_features.astype(np.float32))
